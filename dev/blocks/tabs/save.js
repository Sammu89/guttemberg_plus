...
export default function Save( { attributes } ) {
	...
	const allDefaults = tabsSchema.defaultValues || {};
	...
	if ( attributes.enableFocusBorder === false ) {
		const activeBorderColor =
			attributes.tabButtonActiveBorderColor ?? allDefaults.tabButtonActiveBorderColor;
		const baseBorderWidth =
			attributes.tabButtonBorderWidth ?? allDefaults.tabButtonBorderWidth;
		const baseBorderStyle =
			attributes.tabButtonBorderStyle ?? allDefaults.tabButtonBorderStyle;
	...
	if ( attributes.enableTabsListContentBorder === false ) {
		...
		const rowColor = attributes.tabsRowBorderColor ?? allDefaults.tabsRowBorderColor;
		const rowWidth = attributes.tabsRowBorderWidth ?? allDefaults.tabsRowBorderWidth;
		const rowStyle = attributes.tabsRowBorderStyle ?? allDefaults.tabsRowBorderStyle;

								...
								const buttonElement = (
									...
									>
										<span className="tab-title tab-button-text">
											{ effectiveValues.iconPosition === 'left' &&
												renderIcon() }
											<RichText
												tagName="span"
												value={
										...
										{ isPopupOpen && (
											...
											>
												<button
													...
													title={
														orientation === 'horizontal'
															? __( 'Move left', 'guttemberg-plus' )
															: __( 'Move up', 'guttemberg-plus' )
													}
													type="button"
													disabled={ index === 0 }
												>
												...
												<button
													...
													title={
														orientation === 'horizontal'
															? __( 'Move right', 'guttemberg-plus' )
															: __( 'Move down', 'guttemberg-plus' )
													}
													type="button"
												...
												<button
													...
													className={ `balloon-icon-button balloon-disable ${
														panel.attributes.isDisabled
															? 'is-disabled'
															: ''
													}` }
						...
						<div className="tabs-panels" style={ styles.panel }>
							<InnerBlocks
								...
								template={ [
									[
										'custom/tab-panel',
										{ tabId: `tab-${ generateUniqueId() }`, title: 'Tab 1' },
									],
								] }

 ...
 * @returns {string} JavaScript code for the getCustomizationStyles function
 */
 ...
 * @returns {Object} Object with generated code and metadata
 */
function generateSaveStyleInjection(schema, blockType) {
  ...
  return {
    ...
    usage: {
      ...
      outputToJSX: "...( Object.keys( customizationStyles ).length > 0 && { style: customizationStyles } )",
    },
  };
}
 ...
 * @param {Object} schema - The block's JSON schema
 * @param {string} blockType - Block type identifier
 * @returns {string} Formatted example output
 */

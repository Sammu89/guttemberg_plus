 ...
 * Generated at: 2026-01-18T11:42:01.008Z
 *
...
export const CSS_VAR_MAPPINGS = {
  accordion: {
    dividerBorder: { cssVar: '--accordion-content', unit: null, defaultUnit: null, type: 'border-panel', cssProperty: null, dependsOn: null, variants: null },
    blockBox: { cssVar: '--accordion-item', unit: null, defaultUnit: null, type: 'box-panel', cssProperty: null, dependsOn: null, variants: null },
    headerBox: { cssVar: '--accordion-title', unit: null, defaultUnit: null, type: 'box-panel', cssProperty: null, dependsOn: null, variants: null },
    contentBox: { cssVar: '--accordion-contentInner', unit: null, defaultUnit: null, type: 'box-panel', cssProperty: null, dependsOn: null, variants: null },
    ...
    titleFontSize: { cssVar: '--accordion-title-font-size', unit: 'px', defaultUnit: 'px', type: 'string', cssProperty: 'font-size', dependsOn: null, variants: null },
    titleNoLineBreak: { cssVar: '--accordion-title-white-space', unit: null, defaultUnit: null, type: 'string', cssProperty: 'white-space', dependsOn: null, variants: null },
    titleFontWeight: { cssVar: '--accordion-title-font-weight', unit: null, defaultUnit: null, type: 'string', cssProperty: 'font-weight', dependsOn: null, variants: null },
    ...
    titleLetterSpacing: { cssVar: '--accordion-title-letter-spacing', unit: 'px', defaultUnit: 'px', type: 'string', cssProperty: 'letter-spacing', dependsOn: null, variants: null },
    ...
    titleTextDecoration: { cssVar: '--accordion-title-text-decoration-line', unit: null, defaultUnit: null, type: 'string', cssProperty: 'text-decoration-line', dependsOn: null, variants: null },
    titleLineHeight: { cssVar: '--accordion-title-line-height', unit: null, defaultUnit: null, type: 'string', cssProperty: 'line-height', dependsOn: null, variants: null },
    titleOffsetX: { cssVar: '--accordion-title-offset-x', unit: 'px', defaultUnit: 'px', type: 'string', cssProperty: 'left', dependsOn: null, variants: null },
    titleOffsetY: { cssVar: '--accordion-title-offset-y', unit: 'px', defaultUnit: 'px', type: 'string', cssProperty: 'top', dependsOn: null, variants: null },
    ...
    iconRotation: { cssVar: '--accordion-icon-animation-rotation', unit: 'deg', defaultUnit: 'deg', type: 'string', cssProperty: 'transform', dependsOn: null, variants: null },
    ...
    iconActiveColor: { cssVar: '--accordion-icon-is-open-color', unit: null, defaultUnit: null, type: 'string', cssProperty: 'color', dependsOn: null, variants: null },
    iconActiveRotation: { cssVar: '--accordion-icon-is-open-initial-rotation', unit: 'deg', defaultUnit: 'deg', type: 'string', cssProperty: 'transform', dependsOn: null, variants: null },
    iconActiveSize: { cssVar: '--accordion-icon-is-open-size', unit: 'px', defaultUnit: 'px', type: 'string', cssProperty: 'font-size', dependsOn: null, variants: null },
    iconActiveMaxSize: { cssVar: '--accordion-icon-is-open-max-size', unit: 'px', defaultUnit: 'px', type: 'string', cssProperty: 'max-width', dependsOn: null, variants: null },
    iconActiveOffsetX: { cssVar: '--accordion-icon-is-open-offset-x', unit: 'px', defaultUnit: 'px', type: 'string', cssProperty: 'left', dependsOn: null, variants: null },
    iconActiveOffsetY: { cssVar: '--accordion-icon-is-open-offset-y', unit: 'px', defaultUnit: 'px', type: 'string', cssProperty: 'top', dependsOn: null, variants: null },
  ...
  tabs: {
    ...
    iconRotation: { cssVar: '--tabs-icon-animation-rotation', unit: 'deg', defaultUnit: 'deg', type: 'string', cssProperty: 'transform', dependsOn: null, variants: null },
    ...
    iconActiveColor: { cssVar: '--tabs-icon-is-open-color', unit: null, defaultUnit: null, type: 'string', cssProperty: 'color', dependsOn: null, variants: null },
    iconActiveRotation: { cssVar: '--tabs-icon-is-open-initial-rotation', unit: 'deg', defaultUnit: 'deg', type: 'string', cssProperty: 'transform', dependsOn: null, variants: null },
    iconActiveSize: { cssVar: '--tabs-icon-is-open-size', unit: 'px', defaultUnit: 'px', type: 'string', cssProperty: 'font-size', dependsOn: null, variants: null },
    iconActiveMaxSize: { cssVar: '--tabs-icon-is-open-max-size', unit: 'px', defaultUnit: 'px', type: 'string', cssProperty: 'max-width', dependsOn: null, variants: null },
    iconActiveOffsetX: { cssVar: '--tabs-icon-is-open-offset-x', unit: 'px', defaultUnit: 'px', type: 'string', cssProperty: 'left', dependsOn: null, variants: null },
    iconActiveOffsetY: { cssVar: '--tabs-icon-is-open-offset-y', unit: 'px', defaultUnit: 'px', type: 'string', cssProperty: 'top', dependsOn: null, variants: null },
  },
  toc: {
    ...
    iconRotation: { cssVar: '--toc-icon-animation-rotation', unit: 'deg', defaultUnit: 'deg', type: 'string', cssProperty: 'transform', dependsOn: null, variants: null },
    ...
    iconActiveColor: { cssVar: '--toc-icon-is-open-color', unit: null, defaultUnit: null, type: 'string', cssProperty: 'color', dependsOn: null, variants: null },
    iconActiveRotation: { cssVar: '--toc-icon-is-open-initial-rotation', unit: 'deg', defaultUnit: 'deg', type: 'string', cssProperty: 'transform', dependsOn: null, variants: null },
    iconActiveSize: { cssVar: '--toc-icon-is-open-size', unit: 'px', defaultUnit: 'px', type: 'string', cssProperty: 'font-size', dependsOn: null, variants: null },
    iconActiveMaxSize: { cssVar: '--toc-icon-is-open-max-size', unit: 'px', defaultUnit: 'px', type: 'string', cssProperty: 'max-width', dependsOn: null, variants: null },
    iconActiveOffsetX: { cssVar: '--toc-icon-is-open-offset-x', unit: 'px', defaultUnit: 'px', type: 'string', cssProperty: 'left', dependsOn: null, variants: null },
    iconActiveOffsetY: { cssVar: '--toc-icon-is-open-offset-y', unit: 'px', defaultUnit: 'px', type: 'string', cssProperty: 'top', dependsOn: null, variants: null },

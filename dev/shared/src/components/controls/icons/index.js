...
export const DecorationLineThroughIcon = (
	<svg viewBox="0 0 24 24" width="24" height="24" xmlns="http://www.w3.org/2000/svg">
		<text x="12" y="16" textAnchor="middle" fill="currentColor" fontSize="14" fontWeight="bold">
			S
		</text>
		<line
			x1="6"
...
export const DecorationOverlineIcon = (
	<svg viewBox="0 0 24 24" width="24" height="24" xmlns="http://www.w3.org/2000/svg">
		<line
			...
			strokeLinecap="round"
		/>
		<text x="12" y="18" textAnchor="middle" fill="currentColor" fontSize="14" fontWeight="bold">
			T
		</text>
	</svg>
);
...
export const HeadingNoneIcon = (
	<svg viewBox="0 0 24 20" width="24" height="20" xmlns="http://www.w3.org/2000/svg">
		<text x="12" y="15" textAnchor="middle" fill="currentColor" fontSize="14" fontWeight="500">
			P
		</text>
	</svg>
);
...
export const HeadingH1Icon = (
	<svg viewBox="0 0 24 20" width="24" height="20" xmlns="http://www.w3.org/2000/svg">
		<text x="12" y="15" textAnchor="middle" fill="currentColor" fontSize="12" fontWeight="600">
			H1
		</text>
	</svg>
);
 ...
 * @return {Object} Object containing all icons in the category
 */

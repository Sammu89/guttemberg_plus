...
function setResponsiveValue( currentValue, device, newValue ) {
	...
	const hasDeviceKeys = currentValue && typeof currentValue === 'object' &&
	...
	if ( device === 'global' ) {
		...
		const result = parsedValue && typeof parsedValue === 'object'
			? { ...parsedValue }
			: { value: parsedValue };
		if ( tablet !== undefined ) result.tablet = tablet;
		if ( mobile !== undefined ) result.mobile = mobile;
 ...
 */
function SingleIconMode( { attributes, effectiveValues, onChange, currentDevice, blockType, onResponsiveToggle } ) {
		...
		<div className="single-icon-mode">
			...
			{ ! isImage && (
				<div style={ { marginTop: '16px' } }>
						...
						label={
							<Flex justify="space-between" style={ { width: '100%' } }>
								...
								<UtilityBar
									...
									onReset={ () => {
										onChange( getResponsiveResetUpdate( 'iconInactiveSize', '16px' ) );
									} }
					...
					>
						<SliderWithInput
							value={ parseValueWithUnit( getResponsiveValue( attributes.iconInactiveSize, currentDevice ) || getControlDefault( blockType, 'iconInactiveSize', '16px' ) ) }
							onChange={ ( val ) => {
								const valueStr = typeof val === 'object' && val.value !== undefined
			...
			{ isImage && (
				<div style={ { marginTop: '16px' } }>
					<BaseControl
						label={
							<Flex justify="space-between" style={ { width: '100%' } }>
								...
								<UtilityBar
									canBeResponsive={ true }
									isResponsiveEnabled={ attributes.responsiveEnabled?.iconInactiveMaxSize || false }
									currentDevice={ currentDevice }
									onResponsiveToggle={ () => onResponsiveToggle( 'iconInactiveMaxSize', true ) }
									onReset={ () => {
										onChange( getResponsiveResetUpdate( 'iconInactiveMaxSize', '32px' ) );
									} }
									resetDisabled={ ! attributes.iconInactiveMaxSize && currentDevice === 'global' }
								/>
							</Flex>
						}
						__nextHasNoMarginBottom
					>
						<SliderWithInput
							value={ parseValueWithUnit( getResponsiveValue( attributes.iconInactiveMaxSize, currentDevice ) || getControlDefault( blockType, 'iconInactiveMaxSize', '32px' ) ) }
							onChange={ ( val ) => {
								const valueStr = typeof val === 'object' && val.value !== undefined
									? `${ val.value }${ val.unit || 'px' }`
									: `${ val }px`;
								onChange( {
									iconInactiveMaxSize: setResponsiveValue(
										...
										attributes.responsiveEnabled?.iconInactiveMaxSize ? currentDevice : 'global',
										valueStr
									),
								} );
							} }
			...
			<div style={ { marginTop: '16px' } }>
				<BaseControl
					label={
						<Flex justify="space-between" style={ { width: '100%' } }>
							...
							<UtilityBar
								canBeResponsive={ true }
								isResponsiveEnabled={ attributes.responsiveEnabled?.iconInactiveOffsetX || false }
								currentDevice={ currentDevice }
								onResponsiveToggle={ () => onResponsiveToggle( 'iconInactiveOffsetX', true ) }
								onReset={ () => {
									onChange( getResponsiveResetUpdate( 'iconInactiveOffsetX', '0px' ) );
								} }
								resetDisabled={ ! attributes.iconInactiveOffsetX && currentDevice === 'global' }
							/>
						</Flex>
					}
					__nextHasNoMarginBottom
				>
					<SliderWithInput
						value={ parseValueWithUnit( getResponsiveValue( attributes.iconInactiveOffsetX, currentDevice ) || getControlDefault( blockType, 'iconInactiveOffsetX', '0px' ) ) }
						onChange={ ( val ) => {
							const valueStr = typeof val === 'object' && val.value !== undefined
								? `${ val.value }${ val.unit || 'px' }`
								: `${ val }px`;
							onChange( {
								iconInactiveOffsetX: setResponsiveValue(
									...
									attributes.responsiveEnabled?.iconInactiveOffsetX ? currentDevice : 'global',
									valueStr
								),
							} );
						} }
			...
			<div style={ { marginTop: '16px' } }>
				<BaseControl
					label={
						<Flex justify="space-between" style={ { width: '100%' } }>
							...
							<UtilityBar
								canBeResponsive={ true }
								isResponsiveEnabled={ attributes.responsiveEnabled?.iconInactiveOffsetY || false }
								currentDevice={ currentDevice }
								onResponsiveToggle={ () => onResponsiveToggle( 'iconInactiveOffsetY', true ) }
								onReset={ () => {
									onChange( getResponsiveResetUpdate( 'iconInactiveOffsetY', '0px' ) );
								} }
								resetDisabled={ ! attributes.iconInactiveOffsetY && currentDevice === 'global' }
							/>
						</Flex>
					}
					__nextHasNoMarginBottom
				>
					<SliderWithInput
						value={ parseValueWithUnit( getResponsiveValue( attributes.iconInactiveOffsetY, currentDevice ) || getControlDefault( blockType, 'iconInactiveOffsetY', '0px' ) ) }
						onChange={ ( val ) => {
							const valueStr = typeof val === 'object' && val.value !== undefined
								? `${ val.value }${ val.unit || 'px' }`
								: `${ val }px`;
							onChange( {
								iconInactiveOffsetY: setResponsiveValue(
									...
									attributes.responsiveEnabled?.iconInactiveOffsetY ? currentDevice : 'global',
									valueStr
								),
							} );
						} }
 ...
 */
function IconStateControls( { state, attributes, effectiveValues, onChange, currentDevice, blockType, onResponsiveToggle } ) {
		...
		<div className={ `icon-state-${ state }` } style={ { marginTop: '16px' } }>
			...
			{ ! isImage && (
				<div style={ { marginTop: '16px' } }>
					<BaseControl
						label={
							<Flex justify="space-between" style={ { width: '100%' } }>
								...
								<UtilityBar
									canBeResponsive={ true }
									isResponsiveEnabled={ attributes.responsiveEnabled?.[ `${ prefix }Size` ] || false }
									currentDevice={ currentDevice }
									onResponsiveToggle={ () => onResponsiveToggle( `${ prefix }Size`, true ) }
									onReset={ () => {
										onChange( getResponsiveResetUpdate( `${ prefix }Size`, '16px' ) );
									} }
									resetDisabled={ ! attributes[ `${ prefix }Size` ] && currentDevice === 'global' }
								/>
							</Flex>
						}
						__nextHasNoMarginBottom
					>
						<SliderWithInput
							value={ parseValueWithUnit( getResponsiveValue( attributes[ `${ prefix }Size` ], currentDevice ) || getControlDefault( blockType, `${ prefix }Size`, '16px' ) ) }
							onChange={ ( val ) => {
								const valueStr = typeof val === 'object' && val.value !== undefined
									? `${ val.value }${ val.unit || 'px' }`
									: `${ val }px`;
								onChange( {
									[ `${ prefix }Size` ]: setResponsiveValue(
										...
										attributes.responsiveEnabled?.[`${prefix}Size`] ? currentDevice : 'global',
										valueStr
									),
								} );
							} }
			...
			{ isImage && (
				<div style={ { marginTop: '16px' } }>
					<BaseControl
						label={
							<Flex justify="space-between" style={ { width: '100%' } }>
								...
								<UtilityBar
									canBeResponsive={ true }
									isResponsiveEnabled={ attributes.responsiveEnabled?.[ `${ prefix }MaxSize` ] || false }
									currentDevice={ currentDevice }
									onResponsiveToggle={ () => onResponsiveToggle( `${ prefix }MaxSize`, true ) }
									onReset={ () => {
										onChange( getResponsiveResetUpdate( `${ prefix }MaxSize`, '32px' ) );
									} }
									resetDisabled={ ! attributes[ `${ prefix }MaxSize` ] && currentDevice === 'global' }
								/>
							</Flex>
						}
						__nextHasNoMarginBottom
					>
						<SliderWithInput
							value={ parseValueWithUnit( getResponsiveValue( attributes[ `${ prefix }MaxSize` ], currentDevice ) || getControlDefault( blockType, `${ prefix }MaxSize`, '32px' ) ) }
							onChange={ ( val ) => {
								const valueStr = typeof val === 'object' && val.value !== undefined
									? `${ val.value }${ val.unit || 'px' }`
									: `${ val }px`;
								onChange( {
									[ `${ prefix }MaxSize` ]: setResponsiveValue(
										...
										attributes.responsiveEnabled?.[`${prefix}MaxSize`] ? currentDevice : 'global',
										valueStr
									),
								} );
							} }
			...
			<div style={ { marginTop: '16px' } }>
				<BaseControl
					label={
						<Flex justify="space-between" style={ { width: '100%' } }>
							...
							<UtilityBar
								canBeResponsive={ true }
								isResponsiveEnabled={ attributes.responsiveEnabled?.[ `${ prefix }OffsetX` ] || false }
								currentDevice={ currentDevice }
								onResponsiveToggle={ () => onResponsiveToggle( `${ prefix }OffsetX`, true ) }
								onReset={ () => {
									onChange( getResponsiveResetUpdate( `${ prefix }OffsetX`, '0px' ) );
								} }
								resetDisabled={ ! attributes[ `${ prefix }OffsetX` ] && currentDevice === 'global' }
							/>
						</Flex>
					}
					__nextHasNoMarginBottom
				>
					<SliderWithInput
						value={ parseValueWithUnit( getResponsiveValue( attributes[ `${ prefix }OffsetX` ], currentDevice ) || getControlDefault( blockType, `${ prefix }OffsetX`, '0px' ) ) }
						onChange={ ( val ) => {
							const valueStr = typeof val === 'object' && val.value !== undefined
								? `${ val.value }${ val.unit || 'px' }`
								: `${ val }px`;
							onChange( {
								[ `${ prefix }OffsetX` ]: setResponsiveValue(
									...
									attributes.responsiveEnabled?.[`${prefix}OffsetX`] ? currentDevice : 'global',
									valueStr
								),
							} );
						} }
			...
			<div style={ { marginTop: '16px' } }>
				<BaseControl
					label={
						<Flex justify="space-between" style={ { width: '100%' } }>
							...
							<UtilityBar
								canBeResponsive={ true }
								isResponsiveEnabled={ attributes.responsiveEnabled?.[ `${ prefix }OffsetY` ] || false }
								currentDevice={ currentDevice }
								onResponsiveToggle={ () => onResponsiveToggle( `${ prefix }OffsetY`, true ) }
								onReset={ () => {
									onChange( getResponsiveResetUpdate( `${ prefix }OffsetY`, '0px' ) );
								} }
								resetDisabled={ ! attributes[ `${ prefix }OffsetY` ] && currentDevice === 'global' }
							/>
						</Flex>
					}
					__nextHasNoMarginBottom
				>
					<SliderWithInput
						value={ parseValueWithUnit( getResponsiveValue( attributes[ `${ prefix }OffsetY` ], currentDevice ) || getControlDefault( blockType, `${ prefix }OffsetY`, '0px' ) ) }
						onChange={ ( val ) => {
							const valueStr = typeof val === 'object' && val.value !== undefined
								? `${ val.value }${ val.unit || 'px' }`
								: `${ val }px`;
							onChange( {
								[ `${ prefix }OffsetY` ]: setResponsiveValue(
									...
									attributes.responsiveEnabled?.[`${prefix}OffsetY`] ? currentDevice : 'global',
									valueStr
								),
							} );
						} }

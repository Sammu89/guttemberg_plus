...
const headingIcons = {
	...
	h1: (
		<svg width="24" height="20" viewBox="0 0 24 20" fill="none">
			<text x="12" y="15" textAnchor="middle" fontSize="12" fill="currentColor" fontWeight="700">H1</text>
		</svg>
	),
	h2: (
		<svg width="24" height="20" viewBox="0 0 24 20" fill="none">
			<text x="12" y="15" textAnchor="middle" fontSize="12" fill="currentColor" fontWeight="700">H2</text>
		</svg>
	),
	h3: (
		<svg width="24" height="20" viewBox="0 0 24 20" fill="none">
			<text x="12" y="15" textAnchor="middle" fontSize="12" fill="currentColor" fontWeight="700">H3</text>
		</svg>
	),
	h4: (
		<svg width="24" height="20" viewBox="0 0 24 20" fill="none">
			<text x="12" y="15" textAnchor="middle" fontSize="12" fill="currentColor" fontWeight="700">H4</text>
		</svg>
	),
	h5: (
		<svg width="24" height="20" viewBox="0 0 24 20" fill="none">
			<text x="12" y="15" textAnchor="middle" fontSize="12" fill="currentColor" fontWeight="700">H5</text>
		</svg>
	),
	h6: (
		<svg width="24" height="20" viewBox="0 0 24 20" fill="none">
			<text x="12" y="15" textAnchor="middle" fontSize="12" fill="currentColor" fontWeight="700">H6</text>
		</svg>
	),
};
		...
		>
			<ButtonGroup className="gutplus-heading-level-control__buttons">
				{ headingOptions.map( ( option ) => (
					<Button
						key={ option.value }
						className={ `gutplus-heading-level-control__button ${ value === option.value ? 'is-selected' : '' }` }

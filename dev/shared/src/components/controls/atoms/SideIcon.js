...
const sideIcons = {
	top: (
		<svg width="18" height="18" viewBox="0 0 18 18" fill="none">
			<rect x="2" y="2" width="14" height="14" stroke="currentColor" strokeWidth="1" opacity="0.3" />
	...
	margin: (
		<svg width="18" height="18" viewBox="0 0 18 18" fill="none">
			...
			<rect x="2" y="2" width="14" height="14" stroke="currentColor" strokeWidth="1" strokeDasharray="2,1" opacity="0.5" />
		</svg>
	),
	padding: (
		<svg width="18" height="18" viewBox="0 0 18 18" fill="none">
...
export function SideIcon( { side = 'all' } ) {
	return (
		<span className="gutplus-side-icon">
			{ sideIcons[ side ] || sideIcons.all }
		</span>
	);
}

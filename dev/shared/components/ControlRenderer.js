...
import { getAvailableUnits, isUnitlessProperty } from '../config/css-scales.mjs';
			...
			return (
				<FormattingControl
					...
					value={ {
						...
						decorationWidth: attributes[ decorationWidthKey ] || 'auto',
						noLineBreak:
							( effectiveValues?.[ noLineBreakKey ] ?? attributes[ noLineBreakKey ] ) ===
							'nowrap',
					} }
					...
					onChange={ ( newValue ) => {
						...
						setAttributes( {
							...
							[ decorationWidthKey ]: newValue.decorationWidth,
							[ noLineBreakKey ]: newValue.noLineBreak ? 'nowrap' : 'normal',
							[ textDecorationKey ]: decorationLineValue,
						} );
					} }

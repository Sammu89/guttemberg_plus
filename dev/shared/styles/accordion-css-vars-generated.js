 ...
 * Generated at: 2026-01-18T11:42:00.937Z
 *
 ...
 *
 * Typography fields auto-generated from schema: fontFamily, fontSize, lineHeight, fontWeight, letterSpacing, textTransform, textDecoration
 */
function expandPanelType(cssVar, value, type, styles) {
  ...
  if (type === 'typography-panel') {
    ...
    if (value.fontWeight) styles[`${cssVar}-font-weight`] = value.fontWeight;
    if (value.letterSpacing) styles[`${cssVar}-letter-spacing`] = value.letterSpacing;
    if (value.textTransform) styles[`${cssVar}-text-transform`] = value.textTransform;
    if (value.textDecoration) styles[`${cssVar}-text-decoration-line`] = value.textDecoration;
    // Hover states
    if (value.hover) {
      if (value.hover.fontFamily) styles[`${cssVar}-font-family-hover`] = value.hover.fontFamily;
      if (value.hover.fontSize) styles[`${cssVar}-font-size-hover`] = value.hover.fontSize;
      if (value.hover.lineHeight) styles[`${cssVar}-line-height-hover`] = value.hover.lineHeight;
      if (value.hover.fontWeight) styles[`${cssVar}-font-weight-hover`] = value.hover.fontWeight;
      if (value.hover.letterSpacing) styles[`${cssVar}-letter-spacing-hover`] = value.hover.letterSpacing;
      if (value.hover.textTransform) styles[`${cssVar}-text-transform-hover`] = value.hover.textTransform;
      if (value.hover.textDecoration) styles[`${cssVar}-text-decoration-line-hover`] = value.hover.textDecoration;
    }
    return;
  }

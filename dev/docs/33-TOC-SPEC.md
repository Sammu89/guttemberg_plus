...
> **⚠️ SCHEMA UPDATE NOTICE (Phase 6 - December 2025)**
>
> This specification document contains **outdated schema information** regarding heading level attributes.
>
> **OLD NAMING (in this doc):**
> - `level1Color`, `level1FontSize` → Actually controlled H2
> - `level2Color`, `level2FontSize` → Actually controlled H3
> - `level3PlusColor`, `level3PlusFontSize` → Controlled H4-H6
>
> **NEW NAMING (current implementation):**
...
> - `h3Color` through `h6Color` (same pattern for each level)
> - **Total: 36 heading attributes** (6 levels × 6 properties)
>
> **NEW FEATURES:**
> - Dropdown heading selector in sidebar (space-efficient UI)
> - Hierarchical indentation toggle (`enableHierarchicalIndent`)
> - Multi-unit indentation support (px, rem, em, %)
> - CSS classes changed from `.toc-level-N` to `.toc-hN`
>
> **For current documentation, see:**
> - `/docs/toc-attributes.md` (auto-generated, always up-to-date)
> - `/TOC_Implementation.md` (Phase 6 feature documentation)

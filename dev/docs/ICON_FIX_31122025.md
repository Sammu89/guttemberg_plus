...
const AlternativePositionIcons = {
  left: <svg>...</svg>,
  right: <svg>...</svg>,
  'box-left': <svg>...</svg>,  // Same as left icon, distinguished by label
  'box-right': <svg>...</svg>, // Same as right icon, distinguished by label
};
...
- [ ] Accordion/TOC show 4 positions (left, right, box-left, box-right)

...
// ═══════════════════════════════════════════════════════════════════════════
// CHECK 4: CSS Variable Generation (Forward Check)
...
// ═══════════════════════════════════════════════════════════════════════════
// CHECK 4.5: CSS Variable Mapping Completeness (Reverse Check)
// Ensures schema attributes with cssVar are mapped for generation in save.js
...
function checkCssClassConcordance( blockType ) {
	...
	while ( ( match = templateClassRegex.exec( frontendCode ) ) !== null ) {
		...
		if ( template.includes( '${' ) ) {
			...
			const dynamicClassPatternNoHyphen = /([\w-]+)\$\{/g;
			let dynMatch;

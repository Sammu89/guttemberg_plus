...
export const TABS_CONFIG: Record<string, AttributeConfig> = {
  ...
  tabs: {
    ...
    themeable: false,
    type: 'array',
    defaultValue: [{"id":"","title":"Tab 1","content":"","isDisabled":false},{"id":"","title":"Tab 2","content":"","isDisabled":false}],
    label: 'Tabs',
 ...
 */
export const TABS_CSS_VAR_MAPPING: Record<string, string> = Object.entries(TABS_CONFIG)
  .reduce((acc, [key, cfg]) => {
    if (cfg.cssVar) {
      acc[key] = cfg.cssVar;
    }

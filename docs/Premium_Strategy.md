...
| Level | Attributes |
|-------|------------|
| **Level 1 (H2)** | `level1Color`, `level1FontSize` (1.125rem), `level1FontWeight` (600), `level1FontStyle`, `level1TextTransform`, `level1TextDecoration` |
| **Level 2 (H3)** | `level2Color`, `level2FontSize` (1rem), `level2FontWeight` (normal), `level2FontStyle`, `level2TextTransform`, `level2TextDecoration` |
| **Level 3+ (H4-H6)** | `level3PlusColor`, `level3PlusFontSize` (0.875rem), `level3PlusFontWeight`, `level3PlusFontStyle`, `level3PlusTextTransform`, `level3PlusTextDecoration` |
